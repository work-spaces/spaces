    ...
    match config {
        GlobalsConfig::All => {
            builder = builder
                ...
                .with_namespace("io", starstd::io::globals)
                ...
                .with_namespace("signal", starstd::signal::globals)
                .with_namespace("string", starstd::string::globals)
                .with_namespace("sys", starstd::sys::globals)
                .with_namespace("text", starstd::text::globals)
...
pub fn evaluate_ast(
    ...
    for load_result in &loads {
        ...
        if let Some(ref child_result) = load_result.module_deps {
...
pub fn evaluate_starlark_modules(
    ...
    let is_enable_all_builtins = workspace
        .read()
        .features
        .is_enabled(features::Feature::EnableAllBuiltins);

    let globals_config =
        if singleton::get_inspect_options().stardoc.is_some() || is_enable_all_builtins {
