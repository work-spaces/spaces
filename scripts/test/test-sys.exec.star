...
sys_results["os_and_arch"]["os_valid_value"] = os_name in ["linux", "macos", "windows"]

# Test sys_arch - returns CPU architecture
arch_name = sys_arch()
sys_results["os_and_arch"]["arch_is_string"] = len(arch_name) > 0
sys_results["os_and_arch"]["arch_valid_value"] = arch_name in ["x86_64", "aarch64", "arm", "wasm32"]
...
sys_results["host_and_user"]["home_is_absolute"] = home.startswith("/") or home.startswith("C:\\") or home.startswith("c:\\")
